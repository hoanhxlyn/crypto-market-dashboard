...
3. **Card content** - Each card shows: coin icon, name, symbol, current price in USD (formatted), and 24h price change
   percentage (green for positive, red for negative).
...
Be prepared to explain your decisions, tradeoffs, and what you'd improve with more time. Good luck, and have fun!
